            ...
            <div id='About' className='bg-[#09655A] mt-[-2px] pt-[40px] sm:pt-[45px] pb-[20px] md:pt-[76px] relative'>
                ...
                <div className='container mx-auto xl:max-w-[1136px] lg:px-3 px-6'>
                    <div className='flex flex-col justify-center items-center'>
                        <h3 className='ff_luckydino text-[#fff] text-[45px] sm:text-[69px] text-center font-normal leading-[100%] drop-shadow-[0px_1.1337px_0px_#000] cursor-pointer m-0 pb-[18px] sm:pb-[24px] md:pb-[48px]' data-aos="fade-up"><span className='ff_Chewy text-[49px] sm:text-[64px]'>About</span> <span className='text-[#FBA11D]'>D</span><span className='text-[#23AAAC]'>i</span><span className='text-[#D45B07]'>n</span><span className='text-[#8EC627]'>o</span><span className='text-[#FCCA2B]'>L</span><span className='text-[#8F78D2]'>F</span><span className='text-[#FBA11D]'>G</span></h3>
