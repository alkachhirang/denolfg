            ...
            <div className='container mx-auto lg:px-3 px-6 xl:max-w-[1156px] pt-[20px] sm:pt-[28px]'>
                <div className='rounded-[61.102px] border-b-[4px] border-b-[#000000] border-solid bg-[#fff] lg:pt-[4px] lg:pb-[5px] lg:pr-[8px] lg:pl-[24px] px-[24px] py-[15px]'>
                    <div className='flex justify-between items-center'>
                        <h1 className='ff_luckydino m-0 text-[30px] sm:text-[39.125px] font-normal leading-[94%] drop-shadow-[0px_1.1337px_0px_#000] cursor-pointer'><span className='text-[#FBA11D]'>D</span><span className='text-[#23AAAC]'>i</span><span className='text-[#D45B07]'>n</span><span className='text-[#8EC627]'>o</span><span className='text-[#FCCA2B]'>L</span><span className='text-[#8F78D2]'>F</span><span className='text-[#FBA11D]'>G</span></h1>
